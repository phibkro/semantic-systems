...
flowchart LR
    ...
    work_effect_schema_public_snapshot_boundary["Adopt Effect Schema at the public snapshot boundary"]
    ...
    work_effect_schema_public_snapshot_boundary -->|requires| work_control_room_reconstruction
