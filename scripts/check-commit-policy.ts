  ...
  [
    [
      "githooks/commit-msg",
      {
        ...
        executable: true,
        contentDigest: "sha256:796f9f4848f084aeea9ae146c000675e824bdc1aaefffb31dabcf4b4bcc0f8bf",
      },
    ],
    [
      "githooks/pre-commit",
...
const EXPECTED_PROJECT_CLAIMS: ReadonlyMap<string, ExpectedClaim> = new Map<string, ExpectedClaim>([
  [
    "project/githooks/pre-push",
    {
      ...
      executable: true,
      contentDigest: "sha256:6976b2ba268ea85b3332250a252fc5df46e67ffcae9dbcd7def9fcebb3ab44dc",
    },
  ],
]);
