...
export const ENFORCEMENT_REGISTER: ReadonlyArray<EnforcementRegisterEntry> = Object.freeze([
  ...
  artifact(
    ...
    "nix-develop",
    "runtime_checked",
    "justfile; scripts/run-feature-acceptance.ts",
  ),
  artifact(
  ...
  artifact(
    ...
    "A nontrivial feature owns one ID across its design spec, plan, model record, acceptance script, branch, and pull request.",
    "CONTRIBUTING.md#69-77",
    "pull-request",
    "static",
    "scripts/check-feature-contract.ts; src/project-model/work-lifecycle.ts",
  ),
  reviewOnly(
  ...
  artifact(
    ...
    "`bun run check:references` dispatches the focused reference-custody gate.",
    "package.json#scripts.check:references",
    "bun-1.3.13",
    "runtime_checked",
    "package.json; scripts/check-references.ts",
  ),
  artifact(
  ...
  artifact(
    "check-feature-contract.design-lens",
    "Feature pull requests satisfy the required design-lens sections and markers.",
    "scripts/check-feature-contract.ts#39-60,405-456",
    "pull-request",
    "static",
    "scripts/check-feature-contract.ts",
  ),
  artifact(
    "check-feature-contract.migrations",
    "Feature pull requests account for canonical lifecycle migrations and ownership.",
    "scripts/check-feature-contract.ts#478-561",
    "pull-request",
    "static",
    "scripts/check-feature-contract.ts; src/project-model/work-lifecycle.ts",
  ),
