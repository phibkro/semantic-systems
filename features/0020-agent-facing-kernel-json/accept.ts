...
const contractArtifacts = [
  "features/0020-agent-facing-kernel-json/spec.md",
  "features/0020-agent-facing-kernel-json/plan.md",
  "features/0020-lossless-kernel-source/spec.md",
  "features/0020-lossless-kernel-source/plan.md",
...
const program = Effect.gen(function* () {
  ...
  for (const command of [
    ...
    [
      ...
      "spec/kernel-json",
      "features/0020-agent-facing-kernel-json/accept.ts",
    ],
