...
const requiredArtifacts = [
  "features/0051-kernel-finite-sums/spec.md",
  "features/0051-kernel-finite-sums/plan.md",
...
const program = Effect.gen(function* () {
  ...
  for (const command of [
    ...
    [
      ...
      "spec/kernel-json",
      "features/0051-kernel-finite-sums/accept.ts",
    ],
    ["bun", "features/0018-minimal-kernel-calculus/accept.ts"],
    ["bun", "features/0019-normalized-core-format/accept.ts"],
    ["bun", "features/0020-agent-facing-kernel-json/accept.ts"],
    ["bun", "features/0022-kernel-reference-interpreter/accept.ts"],
