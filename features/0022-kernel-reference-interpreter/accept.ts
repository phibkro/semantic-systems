...
const contractArtifacts = [
  "features/0022-kernel-reference-interpreter/spec.md",
  "features/0022-kernel-reference-interpreter/plan.md",
...
const program = Effect.gen(function* () {
  ...
  for (const command of [
    ...
    [
      ...
      "tests/kernel-reference-interpreter.test.ts",
      "tests/kernel-reference-interpreter-node.test.ts",
      "features/0022-kernel-reference-interpreter/accept.ts",
      "features/0022-kernel-reference-interpreter/spec.md",
      "features/0022-kernel-reference-interpreter/plan.md",
      "generated/project-model/work-features.json",
    ],
