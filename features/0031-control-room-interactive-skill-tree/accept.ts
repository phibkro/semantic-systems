...
const artifacts = [
  "features/0031-control-room-interactive-skill-tree/spec.md",
  "features/0031-control-room-interactive-skill-tree/plan.md",
...
const program = Effect.gen(function* () {
  ...
  yield* runCommand(["bun", "features/0021-pbk-portfolio-control-room/accept.ts"], { cwd: root });
});
